...
So, let's walk through this sample application.  What you're looking at here is the `index.html` page of the Todo application.  It's really nothing fancy - just some standard HTML and CSS (using the Bootstrap CSS library that I introduced in the beginning of the book), and a couple of script tags with references to ECMAScript 5 JavaScript files.  
...
First, I need to convert the prototype-based approach into a class.
