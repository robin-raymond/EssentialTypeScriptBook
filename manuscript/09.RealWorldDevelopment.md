...
I'll start by renaming the file.

	[ Rename TodoService.js -> .ts ]
	
As I do this, I see that TypeScript is pretty upset with me, giving me a lot of errors and warnings because I'm doing things like attaching methods to a prototype object that TypeScript doesn't know anything about.
...
This will download all of the type information and add it to my project in a new folder named "typings".
	...
	[ Open Code, go to "typings" folder, open "jquery.d.ts" ]
...
And, since I'm in here, I'll move those static variables out of the class and into the module scope so that they can be truly private.
	...
	[ move and refactor static members ]
...
And, I'll import the Todo interface from the Model…
...
And then there's the TodoApp component…

	[TodoApp]

Just like the others, I'll import my dependencies and export the TodoApp class.  
...
But, how'd the browser know which source map to load?  

	[ Open Code ]

Well, if I jump back to the generated JavaScript and scroll alllll the way to the end, I see this comment at the bottom:
